...
Summary:        ROS ament_cmake_uncrustify package

License:        Apache License 2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-rolling-ament-cmake-test
Requires:       ros-rolling-ament-uncrustify
...
%description
The CMake API for ament_uncrustify to check code against styleconventions using
uncrustify.
